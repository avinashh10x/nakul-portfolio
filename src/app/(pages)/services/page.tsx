  ...
  return (
    <div className="min-h-screen bg-white">
      <SectionHeader
        ref={headerRef}
        label="Services"
        heading="Tailored creative solutions."
        subheading="End-to-end video editing and motion design — from concept to final delivery, optimized for your platform and audience."
        as="h1"
      ...
      <div className="py-24">
        <div className="max-w-[1200px] mx-auto px-6 md:px-16 text-center">
          ...
          <p className="text-lg text-black/70 max-w-lg mx-auto mb-10">
            ...
            requirements and build a custom package.
          </p>
          <Link
            href="/contact"
