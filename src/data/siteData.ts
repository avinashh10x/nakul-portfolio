...
export const socialLinks = [
  ...
  {
    label: "Instagram",
    url: "https://www.instagram.com/nakul_makes",
    iconPath:
  ...
  {
    label: "LinkedIn",
    url: "https://www.linkedin.com/in/nakul-choudhary01/",
    iconPath:
...
export const aboutPageData = {
  headline: "Where raw footage becomes unforgettable narrative.",
  profileImage: "/img/nakul1.jpeg",
  bio: [
    "I'm a video editor and motion designer based in Punjab with over 4 years of experience crafting visual narratives for brands, artists, and creators.",
    "My journey started with a fascination for how a single cut can change the entire emotion of a scene",
...
export const experienceData = {
  heading: "Disciplines that define the craft.",
  subheading:
    "Deep command of the tools and techniques behind every frame.",
  slides: [
    {
      title: "Video Editing",
...
export const projectsData = [
  {
    ...
    heroImage:
      "/img/w1.png",
    videoUrl:
      "https://res.cloudinary.com/dwuotv4f8/video/upload/v1772566505/1_p7yfuf.mp4",
    description:
      "A mini-documentary exploring the creative underground of Punjab with handheld footage and natural light.",
    challenge:
  ...
  },
  {
    ...
    heroImage:
      "/img/w2.png",
    videoUrl:
      "https://res.cloudinary.com/dwuotv4f8/video/upload/v1772566506/3_tmuesz.mp4",
    description:
  ...
  },
  {
    ...
    heroImage:
      "/img/w2.png",
    videoUrl:
      "https://res.cloudinary.com/dwuotv4f8/video/upload/v1772566514/Copy_of_Devin_Jatho_pqilct.mp4",
    description:
  ...
  },
  {
    ...
    heroImage:
      "/img/w1.png",
    videoUrl:
      "https://res.cloudinary.com/dwuotv4f8/video/upload/v1772566504/Copy_of_Minimal_3d_y8q63m.mp4",
    description:
      "A mini-documentary exploring the creative underground of Punjab with handheld footage and natural light.",
    challenge:
      "12 hours of raw handheld footage, no script, multiple interview subjects with contradicting narratives.",
...
export const contactPageData = {
  ...
  subtext:
    "Share your project details and let's craft something that leaves a lasting impression.",
...
export const processData = {
  heading: "From vision to final cut.",
  subheading: "A structured creative workflow built for precision and impact.",
  steps: [
    {
      num: "01",
...
export const footerMenus = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Instagram", url: "https://www.instagram.com/nakul_makes" },
      { label: "LinkedIn", url: "https://www.linkedin.com/in/nakul-choudhary01/" },
      { label: "Twitter", url: "https://x.com/Nakul_makes" },
